...
export default function AvailabilityPageClient({ initialSettings, initialAvailability, initialBlockedSlots }: AvailabilityPageClientProps) {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const [availabilityData, blockedSlotsData] = await Promise.all([
        getAvailability(),
        getBlockedSlots()
      ]);
