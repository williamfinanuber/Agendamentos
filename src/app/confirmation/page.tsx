...
function ConfirmationContent() {
  ...
  const signalValue = price * 0.4;

  const whatsappMessage = encodeURIComponent(
    `Olá! Meu nome é ${name}. Gostaria de confirmar meu agendamento e realizar o pagamento do sinal de 40%.\n\n` +
  ...
  const whatsappUrl = `https://wa.me/5563984001146?text=${whatsappMessage}`;
    ...
    <div className="flex justify-center items-center py-8 sm:py-12 md:py-24 px-4">
      <Card className="w-full max-w-lg text-center shadow-2xl">
        ...
        <CardContent className="space-y-4 px-4 pb-6 md:px-6 md:pb-8">
          <p className="text-sm md:text-base">Seu pedido foi recebido! Para garantir seu horário, por favor, finalize pelo WhatsApp.</p>
