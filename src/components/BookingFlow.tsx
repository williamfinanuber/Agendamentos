...
import { createBooking, updateBooking, getAvailabilityForProcedure } from '@/lib/firebase';
...
function BookingFlowContent({ procedures, initialAvailability, existingBooking = null, procedureIdParam }: BookingFlowProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    }, [selectedDate, selectedProcedure, availability]);
                                ...
                                <FormField control={form.control} name="contact" render={({ field }) => (
                                 ...
                                 <Card className="bg-secondary/50 border-primary/20">
                                  <CardContent className="p-4 flex items-start gap-3">
                                    ...
                                    <div>
                                      <h4 className="font-semibold text-card-foreground">Pagamento do Sinal</h4>
                                      <p className="text-sm text-muted-foreground">Para finalizar, você será redirecionada ao WhatsApp para efetuar o pagamento do sinal de 40% e confirmar seu agendamento.</p>
                                    </div>
                                  </CardContent>
                                </Card>
                                <DialogFooter>
